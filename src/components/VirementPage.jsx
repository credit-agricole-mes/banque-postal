// components/VirementPage.jsx - VERSION AVEC BLOCAGE COMPTE BLOQUÉ
...
export default function VirementPage({ navigate, onVirementSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // ⚡ VÉRIFICATION : Bloquer si compte bloqué
    if (user?.isBlocked) {
      alert('❌ Votre compte est bloqué. Vous ne pouvez pas effectuer de virement.\n\nVeuillez contacter votre conseiller pour débloquer votre compte.');
      console.log('🚫 Virement bloqué : compte utilisateur bloqué');
      return;
    }
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 pb-24">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700">
                  Les virements sont désactivés. Contactez votre conseiller pour débloquer votre compte.
                </p>
                {user?.blockReason && (
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* ⚡ Bouton avec blocage si compte bloqué */}
            <button
              type="submit"
